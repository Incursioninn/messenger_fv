...
class GroupChatFragment(private val group: DefaultModel) :
    ...
    private fun initRecyclerView() {
        ...
        mRefToMessages = REF_DATABASE_ROOT.child(NODE_GROUPS).child(group.id).child(NODE_MESSAGES)
    ...
    private fun initToolbar() {
        ...
        mRefToUser = REF_DATABASE_ROOT.child(NODE_USERS).child(group.id)
    ...
    private fun initInfoToolbar() {
        if (mReceivingUser.fullname.isEmpty()) {
            mToolBarInfo.toolbar_chats_fullname.text = group.fullname
        } else mToolBarInfo.toolbar_chats_fullname.text = mReceivingUser.fullname
        mToolBarInfo.toolbar_chats_image.downloadAndSetImage(group.photoUrl)
